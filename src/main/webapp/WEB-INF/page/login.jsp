...
<head>
    ...
    <style type="text/css">
        *{padding:0px;margin:0px;}
        body{font-family:Arial, Helvetica, sans-serif;background:url(../../images/bg_fruit.jpg);font-size:12px;}
        img{border:0;}
        ...
        .bn{width:200px;height:72px;background:url(../../images/enter.png) no-repeat;border:0;display:block;font-size:18px;color:#FFF;font-family:Arial, Helvetica, sans-serif;font-weight:bolder;cursor:pointer;}
        .lg_foot{height:80px;width:330px;padding: 6px 80px 0 68px;}
    </style>
