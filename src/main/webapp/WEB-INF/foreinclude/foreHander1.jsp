            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="header-top-text text-center text-lg-left mb-0 mb-md-15 mb-sm-15">
                        <p><i class="icon ion-md-alarm"></i> 下单后，30分钟内送到宿舍,<span class="support-no"></span></p>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                ...
                <div class="col-6 col-lg-2 col-md-6 col-sm-6 order-1 order-lg-1">
                    ...
                    <div class="logo">
                        <a href="/fore/foreIndex">
                            <img src="${pageContext.request.contextPath}/assets/images/logo1.png" class="img-fluid" alt="">
                        </a>
                    </div>
                    <!--=======  End of logo  =======-->
                </div>
