            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="header-top-text text-center text-lg-left mb-0 mb-md-15 mb-sm-15">
                        <p><i class="icon ion-md-alarm"></i> 耐心坐等，即可享受美味！  <span class="support-no"></span></p>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-6 col-lg-2 col-md-6 col-sm-6 order-1 order-lg-1">
                    ...
                    <div class="logo">
                        <img src="${pageContext.request.contextPath}/assets/images/mylogo.png" class="img-fluid" alt="">
                    </div>
